...
* The original package name 'currency-conversion API.currency-conversion' is invalid and this project uses 'currencyconversion.API.currencyconversion' instead.
